...
local tensor_apply_operation
tensor_apply_operation=function(a,b,op)
	if type(a)~='table' then return op(a,b) end
	local t={}
	if type(b)~='table' then 
		for i,v in ipairs(a) do		t[i]=tensor_apply_operation(v,b)	end
	else
		for i,v in ipairs(a) do		t[i]=tensor_apply_operation(v,b[i])	end
	end
	return t
end
...
local create_tensor=function(t,n,v)
